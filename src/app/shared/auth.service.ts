...
export class AuthService {
  ...
  signUp(user: User): Observable<any> {
    ...
    let api = `${this.endpoint}/user/signup`;
  ...
  signIn(user: User) {
    ...
    return this.http.post<any>(`${this.endpoint}/user/login`, user)
      .subscribe((res: any) => {
        ...
        console.log('this.currentUser', res.user.id);
        this.getUserProfile(res.user.id).subscribe((res) => {
          console.log('this.currentUser user id route solo res', res)
